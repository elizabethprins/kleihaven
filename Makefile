...
URLS = /kleihaven/ /cursussen/ /over-ons/ /air/ /privacy/ /algemene-voorwaarden/ /veelgestelde-vragen/ /
DIST_URLS = $(foreach url, $(URLS), $(DIST_DIR)$(url)/index.html)
BASE_URL ?= $(or $(DEPLOY_URL),$(or $(URL),http://localhost:3000))
